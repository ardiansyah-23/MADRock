...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#E2E8F0] border-b border-slate-300 py-3.5 shadow-sm transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-7">
            <Link
              href="/"
              className="text-sm font-semibold text-slate-800 hover:text-mad-lime transition-colors duration-200"
            >
              {t("nav_home")}
            </Link>
            ...
            >
              <button
                ...
                className="flex items-center gap-1.5 text-sm font-semibold text-slate-800 hover:text-mad-lime transition-colors duration-200"
              >
              ...
              {dropdownOpen && (
                <div className="absolute top-full left-0 pt-2 w-72 z-50 animate-fadeIn">
                  <div className="rounded-2xl bg-white border border-slate-300 p-2 shadow-xl space-y-1">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Link
              href="/ai-coach"
              className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-mad-lime bg-lime-50 border border-lime-300 rounded-full hover:bg-lime-100 transition-all shadow-sm"
            >
            ...
            <Link
              ...
              className="p-2 text-slate-800 hover:text-mad-lime hover:bg-slate-200 rounded-xl transition-all"
              title={
          ...
          <div className="lg:hidden flex items-center gap-2">
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-white text-slate-900 border border-slate-300 hover:text-mad-lime transition-colors"
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-x-0 top-[65px] bg-[#E2E8F0] border-b border-slate-300 px-6 py-6 transition-all animate-fadeIn shadow-2xl">
          <div className="flex flex-col gap-3">
            ...
            <div className="py-2 border-y border-slate-300 my-1 space-y-2">
              ...
              {dropdownItems.map((item) => (
                <Link
                  ...
                  href={item.href}
                  onClick={() => setMobileMenuOpen(false)}
                  className="flex items-center gap-3 py-2 px-3 rounded-xl bg-white border border-slate-300 text-sm font-semibold text-slate-900 hover:text-mad-lime"
                >
            ...
            <div className="pt-4 border-t border-slate-300 flex flex-col gap-3">
              <Link
                href="/ai-coach"
                onClick={() => setMobileMenuOpen(false)}
              ...
              <Link
                href={profileTargetUrl}
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center justify-center gap-2 py-3 rounded-xl bg-white text-slate-900 border border-slate-300 font-semibold text-sm"
              >
