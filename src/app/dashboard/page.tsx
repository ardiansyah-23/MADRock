...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-mad-bg text-white flex flex-col md:flex-row">
      ...
      <aside
        className={`fixed md:sticky top-0 left-0 z-40 h-screen w-64 glass-panel border-r border-white/10 p-6 flex flex-col justify-between transition-transform duration-300 ${
      ...
      <div className="flex-1 min-w-0 flex flex-col min-h-screen">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="glass-card border border-white/10 rounded-xl pl-10 pr-4 py-2 text-xs text-white placeholder-mad-gray focus:outline-none focus:border-mad-lime font-mono w-64"
              />
            </div>
            ...
            <div className="relative" ref={notifRef}>
              <button
                ...
                className="p-2 rounded-xl glass-card border border-white/10 text-mad-gray hover:text-white relative transition-colors"
                title="Notifikasi"
              >
              ...
              {notifOpen && (
                <div className="absolute right-0 top-full mt-3 w-80 sm:w-96 rounded-2xl glass-panel border border-white/10 p-4 shadow-2xl z-50 animate-fadeIn space-y-3">
        ...
        <main className="p-4 sm:p-8 space-y-8 flex-1">
          {/* User Welcome Banner */}
          <div className="rounded-3xl glass-panel border border-white/10 p-6 sm:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-lg relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 z-10">
              <div className="px-4 py-2.5 rounded-2xl glass-card border border-white/10 text-xs font-mono text-mad-gray flex items-center gap-2">
          ...
          {activeTab === "overview" && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                {/* Today's Workout */}
                <div className="lg:col-span-7 rounded-3xl glass-panel border border-white/10 p-6 sm:p-8 space-y-6">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={idx} className="p-4 rounded-2xl glass-card border border-slate-900/5 flex items-center justify-between">
                        <div>
                ...
                {/* Today's Meals */}
                <div className="lg:col-span-5 rounded-3xl glass-panel border border-white/10 p-6 sm:p-8 space-y-6">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={idx} className="p-3.5 rounded-xl glass-card border border-slate-900/5 flex items-center justify-between text-xs">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
                        <span className="px-3 py-1 rounded-lg glass-panel text-xs font-mono text-mad-gray">
                          {ex.rpe}
                        </span>
                        <button
                          ...
                          className={`px-5 py-2.5 rounded-xl font-bold text-xs uppercase font-mono transition-all ${
                            isDone
                              ...
                              : "glass-panel text-white border border-white/10 hover:border-mad-lime"
                          }`}
                        >
            ...
            <div className="rounded-3xl glass-panel border border-white/10 p-6 sm:p-8 space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-white/10">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/10 text-white font-extrabold text-xs uppercase hover:bg-slate-800 transition-all shadow-lg"
                >
              ...
              <div className="space-y-4">
                {bookingsList.map((b) => (
                  <div key={b.id} className="p-5 rounded-2xl glass-card border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        {b.status === "Confirmed" && (
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/10 text-white border border-slate-700 text-xs font-mono font-bold hover:bg-slate-800"
                    >
      ...
      {bookingModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="w-full max-w-lg rounded-3xl glass-panel border border-white/10 p-6 sm:p-8 space-y-6 relative shadow-2xl animate-fadeIn">
            <button
              ...
              <form onSubmit={handleInDashboardBooking} className="space-y-5">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full glass-card border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-mad-lime font-mono"
                  >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full glass-card border border-white/10 rounded-xl px-3 py-2.5 text-xs text-white focus:outline-none focus:border-mad-lime font-mono"
                    />
                  </div>
                ...
                <button
                  type="submit"
                  className="w-full py-4 rounded-2xl bg-mad-lime text-white font-extrabold text-sm uppercase tracking-wider hover:bg-mad-lime-hover shadow-lg"
                >
