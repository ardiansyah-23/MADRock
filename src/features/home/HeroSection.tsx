        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 xl:col-span-7 space-y-6">
            ...
            <ScrollReveal delay={0.15}>
              <p className="text-sm sm:text-base lg:text-lg text-mad-gray max-w-xl font-normal leading-relaxed">
                {t("hero_subtitle")}
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <Link
                  href="/login"
                  className="group inline-flex items-center gap-3 px-7 py-3.5 rounded-2xl text-sm font-extrabold bg-mad-lime text-mad-bg hover:bg-mad-lime-hover transition-all duration-300 shadow-xl shadow-mad-lime/20 hover:scale-[1.02] active:scale-[0.98] transform-gpu"
                >
                ...
                <Link
                  href="/programs"
                  className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-2xl text-sm font-bold bg-white/5 border border-white/15 text-white hover:bg-white/10 hover:border-mad-lime/50 transition-all duration-300 backdrop-blur-md hover:scale-[1.02] active:scale-[0.98] transform-gpu"
                >
            ...
            <ScrollReveal delay={0.25}>
              <div className="pt-2 flex items-center gap-6 text-xs text-mad-gray font-medium">
          ...
          {/* Right Side Image Card - Perfectly Proportioned 5 Columns */}
                ...
                <div className="relative rounded-3xl overflow-hidden border border-white/15 bg-mad-surface shadow-2xl transform-gpu">
                  ...
                  <div className="absolute bottom-5 left-5 right-5 p-3.5 rounded-2xl glass-panel border border-white/10 flex items-center gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-mad-lime font-medium">
            ...
            {stats.map((stat, index) => (
              <ScrollReveal key={index} delay={0.05 * index}>
                <div className="p-4 rounded-2xl glass-card border border-white/5 hover:border-mad-lime/30 transition-all duration-300 transform-gpu">
                  <stat.icon className="w-5 h-5 text-mad-lime mx-auto mb-2 opacity-80" />
